        ...
        if(isPhone){
            ...
            if (bmpValid && mCacheBitmap != null) {
                ...
                if (canvas != null) {
                    ...
                    Log.e("---------->","canvas.getWidth()=" +canvas.getWidth()+";canvas.getHeight()="+canvas.getHeight()+";scale = "+scale);

                    canvas.drawBitmap(mCacheBitmap,( canvas.getHeight()/scale-mCacheBitmap.getWidth())/2, -mCacheBitmap.getHeight(), null);
                    // ===结束这里解决预览旋转90度问题end
                    if (mFpsMeter != null) {
                        mFpsMeter.measure();
