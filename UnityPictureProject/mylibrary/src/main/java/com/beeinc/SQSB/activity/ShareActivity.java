...
public class ShareActivity extends Activity {
    ...
    private View root_view,v_back,v_line_title_left,v_line_title_right,v_content,v_line_share_left,v_line_share_right,v_wx_friend,v_wx_friends,v_qq;
    private TextView tv_title,tv_code_hint,tv_guige,tv_price_hint,tv_remark_hint,tv_share,tv_wx_friend,tv_wx_friends,tv_qq,tv_cancel;
