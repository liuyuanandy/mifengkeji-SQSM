...
public class NetworkUtils {
     ...
     * @return NetworkInfo
     */
    private static NetworkInfo getActiveNetworkInfo(Context con) {
    ...
    public static boolean isConnected(Context con) {
        NetworkInfo info = getActiveNetworkInfo(con);
     ...
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean getDataEnabled(Context con) {
        try {
     ...
     */
    public static void setDataEnabled(Context con, boolean enabled) {
        try {
            TelephonyManager tm = (TelephonyManager) con.getSystemService(Context.TELEPHONY_SERVICE);
     ...
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean is4G(Context con) {
        NetworkInfo info = getActiveNetworkInfo(con);
     ...
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean getWifiEnabled(Context con) {
    ...
    public static boolean isWifiAvailable(Context con) {
        return getWifiEnabled(con) && isAvailableByPing();
    }
     ...
     * </ul>
     */
    public static NetworkType getNetworkType(Context con) {
