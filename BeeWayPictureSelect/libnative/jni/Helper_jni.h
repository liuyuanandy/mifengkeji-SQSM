...
JNIEXPORT void JNICALL Java_com_test_RemapHelper_nativeRemap(JNIEnv*,jclass, jlong srcAddress,jlong map_x,jlong map_y,jint type);
JNIEXPORT void JNICALL Java_com_test_RemapHelper_nativeRotate(JNIEnv*, jclass,jlong srcAddress,jlong dstAddress,jint angle);
JNIEXPORT void JNICALL Java_com_test_RemapHelper_overlayImage(JNIEnv*, jclass,jlong srcAddress,jlong dstAddress,jint x,jint y);
#ifdef __cplusplus
}
#endif
#endif
