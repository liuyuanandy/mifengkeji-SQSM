...
public class MediaReader {
    ...
    private void scanImageFile(Map<String, AlbumFolder> albumFolderMap, AlbumFolder allFileFolder) {
        ...
        Cursor cursor = contentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                ...
                null,
                null,
                MediaStore.Images.Media.DATE_ADDED+" DESC");//或 " ASC"

        if (cursor != null) {
            Log.e("---------->","Album info start");
            while (cursor.moveToNext()) {
                ...
                String uriContentPath =MediaStore.Images.Media
                ...
                imageFile.setUriContentPath(uriContentPath);
                ...
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.P){
                    ...
                    Log.e("-------------->","isFileExists = "+isFileExists);
                }else{
                    File file = new File(imageFile.getPath());
                    isFileExists = file.exists();
                }
    ...
    private void scanVideoFile(Map<String, AlbumFolder> albumFolderMap, AlbumFolder allFileFolder) {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                videoFile.setUriContentPath(uriContentPath);
