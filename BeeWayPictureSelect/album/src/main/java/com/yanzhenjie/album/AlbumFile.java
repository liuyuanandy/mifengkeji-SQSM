...
public class AlbumFile implements Parcelable, Comparable<AlbumFile> {
    ...
    public String getUriContentPath() {
        return uriContentPath;
    }

    public void setUriContentPath(String uriContentPath) {
        this.uriContentPath = uriContentPath;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(uriContentPath);
