...
public class NullActivity extends BaseActivity implements Contract.NullPresenter {
    ...
    private static final String KEY_Q_IMAGE_PATH = "KEY_Q_IMAGE_PATH";

    public static String parsePath(Intent intent) {
        return intent.getStringExtra(KEY_OUTPUT_IMAGE_PATH);
    }
    public static String parseQPath(Intent intent) {
        return intent.getStringExtra(KEY_Q_IMAGE_PATH);
    }
    ...
    private Action<CameraCallBack> mCameraAction = new Action<CameraCallBack>() {
        ...
        public void onAction(@NonNull CameraCallBack result) {
            ...
            intent.putExtra(KEY_OUTPUT_IMAGE_PATH, result.getmCameraFilePath());
            intent.putExtra(KEY_Q_IMAGE_PATH,result.getmUriPath());
