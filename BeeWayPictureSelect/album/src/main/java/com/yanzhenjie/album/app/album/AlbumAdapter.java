...
public class AlbumAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private int imageViewHeigth;

    public void setImageViewInfo(int imageViewWidth,int imageViewHeigth){
        this.imageViewWidth = imageViewWidth;
        this.imageViewHeigth = imageViewHeigth;
    }
    ...
    private  class ImageHolder extends MediaViewHolder implements View.OnClickListener {
        ...
        ImageHolder(View itemView, boolean hasCamera,
            ...
            if(AlbumAdapter.this.imageViewWidth!=0){
                RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(AlbumAdapter.this.imageViewWidth,AlbumAdapter.this.imageViewHeigth);
                mIvImage.setLayoutParams(p);
            }
