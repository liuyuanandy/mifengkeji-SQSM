...
public class Widget implements Parcelable {
    ...
    private Widget(Builder builder) {
        ...
        this.mToolBarColor = builder.mToolBarColor == 0 ? getColor(R.color.albumFontHint) : builder.mToolBarColor;
    ...
    public static Widget getDefaultWidget(Context context) {
        return Widget.newDarkBuilder(context)
                ...
                .toolBarColor(ContextCompat.getColor(context, R.color.albumColorPrimaryDark))
