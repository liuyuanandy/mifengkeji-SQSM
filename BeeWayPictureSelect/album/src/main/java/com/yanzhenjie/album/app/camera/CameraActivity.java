...
import com.yanzhenjie.album.app.album.CameraCallBack;
...
public class CameraActivity extends BaseActivity {
    ...
    public static Action<CameraCallBack> sResult;
    ...
    private void callbackResult() {
        ...
        callBack.setmCameraFilePath(mCameraFilePath);
        callBack.setmUriPath(uriPath);
        if (sResult != null) sResult.onAction(callBack);
        sResult = null;
        sCancel = null;
        finish();
    }
